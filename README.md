...
PROJECT 3(NLP)-TEXT ANALYSIS                                                                                         
●	Webscraped input data from Wikipedia using BeautifulSoup
●	Transformed and processed data by using python to ensure data completeness and validity
●	Utilized spaCy to extract and analyze 204 Wikipedia sentences, performing topic analysis to identify key themes and contextual relationships
...
●	Used FacetGrid to illustrate continent-wise population changes over time for comparative analysis
